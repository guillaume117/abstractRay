...
def resize_dim_1(abstract_domain_1, abstract_domain):
    ...
    """
    if abstract_domain_1['zonotope'] is None:
        return abstract_domain  # Do nothing if zonotope is None
...
def process_max_pool2D_parrallel(abstract_domain, evaluator_rel, maxpool_layer, num_workers, available_ram, device, add_symbol):
    ...
    """
    Process a MaxPool2D layer within the abstract domain, when the fully parralelisation of relevance symbol is True
